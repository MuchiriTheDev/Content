  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 max-w-5xl w-full md:h-fit h-full flex items-center justify-center p-8 bg-white backdrop-blur-md rounded-none md:rounded-xl shadow-none md:shadow-2xl border-nonde md:border border-appleGreen"
      >
        <div className="">
