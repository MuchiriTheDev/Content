    ...
    >
      ...
      >
        <div className="space-y-6">
            ...
            <table className="w-full mt-2 text-sm text-gray-700">
              <tbody>
                <tr>
                  ...
                  <td>{formData.incidentDetails.platform || 'N/A'}</td>
                </tr>
                <tr>
          ...
          <div>
            <h4 className="text-lg md:text-xl font-semibold text-brown flex items-center gap-2">
              <FaCheckCircle className="text-yellowGreen" size={20} /> Evidence Files
            </h4>
            {formData.evidenceFiles.length === 0 ? (
              <p className="text-gray-500 text-sm mt-2">No evidence uploaded.</p>
            ) : (
