      ...
      {/* Futuristic Background Effects */}
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 text-center">
          <Title 
            ...
            headStyle="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-neonPink to-appleGreen"
          ...
          <div className=' bg-appleGreen text-white p-3 text-xl mb-2 flex justify-center items-center rounded-full font-bold'>01.</div>
          ...
          <p className="text-gray-500 text-center text-sm leading-relaxed">
            ...
            <div className="group relative p-6 bg-white rounded-xl flex flex-col justify-center items-center shadow-lg hover:shadow-neon transition-all duration-300 border border-appleGreen/20 text-center">
          <div className="absolute top-0 left-0 w-full h-full bg-neonPink opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-xl"></div>
          <div className=' bg-appleGreen text-white p-3 text-xl mb-2 flex justify-center items-center rounded-full font-bold'>02.</div>
          ...
          <p className="text-gray-500 text-center text-sm leading-relaxed">
            ...
            <div className="group relative p-6 bg-white rounded-xl flex flex-col justify-center items-center shadow-lg hover:shadow-neon transition-all duration-300 border border-appleGreen/20 text-center">
          <div className="absolute top-0 left-0 w-full h-full bg-neonPink opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-xl"></div>
          <div className=' bg-appleGreen text-white p-3 text-xl mb-2 flex justify-center items-center rounded-full font-bold'>03.</div>
        ...
        <div className="mt-16 text-center">
          <Link to='/application' className="relative px-10 py-4 bg-appleGreen text-white font-semibold rounded-lg shadow-lg hover:shadow-neon transition-all duration-300 transform hover:scale-105">
